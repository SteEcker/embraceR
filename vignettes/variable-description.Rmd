...
+---------------------------+------------------------+-----------------------------------------------+
+---------------------------+------------------------+-----------------------------------------------+
| `event_systemic_excl_pao` | Systemic control       | - **Calculation:** Triggered when systemic    |
|                           | (excl. PAO)            |   failure (`event_systemicfailure`) occurs    |
|                           |                        |   AND at least one of: supraclavicular nodes, |
|                           |                        |   mediastinal nodes, liver, bone, brain, lung |
|                           |                        |   metastases, abdominal carcinomatosis, or    |
|                           |                        |   other metastases is present                 |
|                           |                        | - **Implementation:**                         |
...
|                           | control (below L2)     |   para-aortic nodes above L2                  |
...
|                           | Alone                  |   failure occurs (`event_systemicfailure=1`)  |
|                           |                        |   WITHOUT para-aortic nodes above L2 AND      |
|                           |                        |   WITHOUT concurrent local failure or pelvic  |
|                           |                        |   nodal failure                               |
|                           |                        | - **Implementation:**                         |
